  ...
  describe('получение категорий и товаров', function() {
    ...
    describe('товары', () => {
      describe('получение списка товаров по подкатегории', () => {
        it('при передаче несуществующей подкатегории должен возвращаться пустой массив', async () => {
        ...
        it('товары по существующей подкатегории', async () => {
          ...
          ).to.have.keys(['title', 'id', 'category', 'subcategory', 'price', 'description', 'images']);
